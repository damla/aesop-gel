 ...
 */function equalArrays(e,t,a,l,n,i){var s=a&COMPARE_PARTIAL_FLAG,d=e.length,o=t.length;if(d!=o&&!(s&&o>d))return!1;// Assume cyclic values are equal.
...
for(i.set(e,t),i.set(t,e);++u<d;){var _=e[u],f=t[u];if(l)var h=s?l(f,_,u,t,e,i):l(_,f,u,e,t,i);if(void 0!==h){if(h)continue;c=!1;break}// Recursively compare arrays (susceptible to call stack limits).
...
var r=s.get(e);if(r)return r==t;l|=COMPARE_UNORDERED_FLAG$1,s.set(e,t);var u=_equalArrays(d(e),d(t),l,n,i,s);return s["delete"](e),u;case symbolTag:if(symbolValueOf)return symbolValueOf.call(e)==symbolValueOf.call(t);}return!1}var _equalByTag=equalByTag;/**
 ...
 */function arrayLikeKeys(e,t){var a=isArray_1(e),l=!a&&isArguments_1(e),n=!a&&!l&&isBuffer_1(e),i=!a&&!l&&!n&&isTypedArray_1(e),s=a||l||n||i,d=s?_baseTimes(e.length,String):[],o=d.length;for(var r in e)(t||hasOwnProperty$5.call(e,r))&&!(s&&(// Safari 9 has enumerable `arguments.length` in strict mode.
 ...
 * @param {Object} stack Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function equalObjects(e,t,a,l,n,i){var s=a&COMPARE_PARTIAL_FLAG$2,d=_getAllKeys(e),o=d.length,r=_getAllKeys(t),u=r.length;if(o!=u&&!s)return!1;for(var c,m=o;m--;)if(c=d[m],s?!(c in t):!hasOwnProperty$7.call(t,c))return!1;// Assume cyclic values are equal.
var _=i.get(e);if(_&&i.get(t))return _==t;var f=!0;i.set(e,t),i.set(t,e);for(var h=s;++m<o;){c=d[m];var g=e[c],p=t[c];if(l)var E=s?l(p,g,c,t,e,i):l(g,p,c,e,t,i);// Recursively compare objects (susceptible to call stack limits).
 ...
 * @param {Object} [stack] Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function baseIsEqualDeep(e,t,a,l,n,i){var s=isArray_1(e),d=isArray_1(t),o=s?arrayTag$1:_getTag(e),r=d?arrayTag$1:_getTag(t);o=o==argsTag$2?objectTag$2:o,r=r==argsTag$2?objectTag$2:r;var u=o==objectTag$2,c=r==objectTag$2,m=o==r;if(m&&isBuffer_1(e)){if(!isBuffer_1(t))return!1;s=!0,u=!1}if(m&&!u)return i||(i=new _Stack),s||isTypedArray_1(e)?_equalArrays(e,t,a,l,n,i):_equalByTag(e,t,o,a,l,n,i);if(!(a&COMPARE_PARTIAL_FLAG$3)){var _=u&&hasOwnProperty$8.call(e,"__wrapped__"),f=c&&hasOwnProperty$8.call(t,"__wrapped__");if(_||f){var h=_?e.value():e,g=f?t.value():t;return i||(i=new _Stack),n(h,g,a,l,i)}}return!!m&&(i||(i=new _Stack),_equalObjects(e,t,a,l,n,i))}var _baseIsEqualDeep=baseIsEqualDeep;/**
