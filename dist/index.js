...
return null;if("number"==typeof e.tag&&be(!1,"Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case Ie:return"ConcurrentMode";case Te:return"Fragment";case Ce:return"Portal";case ke:return"Profiler";case Ne:return"StrictMode";case xe:return"Suspense";}if("object"===_typeof2(e))switch(e.$$typeof){case Se:return"Context.Consumer";case ve:return"Context.Provider";case Ae:return n(e,e.render,"ForwardRef");case we:return l(e.type);case Oe:{var t=a(e);if(t)return l(t)}}return null}function o(e,t){var a=e.contextTypes;if(!a)return Be;var n={};for(var l in a)n[l]=t[l];return n}function r(e,t,a){he(e,t,a,"Component",He.getCurrentStack)}function s(e,t){// If we don't have enough slots in this context to store this threadID,
...
// render's.
var s=r.action;st=!0,o=e(o,s),st=!1,r=r.next}while(null!==r);return nt.memoizedState=o,[o,l]}}return[nt.memoizedState,l]}st=!0;var d;d=e===L?"function"==typeof t?t():t:void 0===a?t:a(t),st=!1,nt.memoizedState=d;var u=nt.queue={last:null,dispatch:null},c=u.dispatch=F.bind(null,tt,u);return[nt.memoizedState,c]}function D(e,t){tt=S(),nt=x();var a=void 0===t?null:t;if(null!==nt){var n=nt.memoizedState;if(null!==n&&null!==a){var l=n[1];if(I(a,l))return n[0]}}st=!0;var i=e();return st=!1,nt.memoizedState=[i,a],i}function H(e){tt=S(),nt=x();var t=nt.memoizedState;if(null===t){var a={current:e};return Object.seal(a),nt.memoizedState=a,a}return t}function F(e,a,n){if(25>rt?void 0:t(!1,"Too many re-renders. React limits the number of renders to prevent an infinite loop."),e===tt){it=!0;var l={action:n,next:null};null===ot&&(ot=new Map);var i=ot.get(a);if(void 0===i)ot.set(a,l);else{// Append the update to the end of the list.
...
Pt(e.replace(St,"ms-"))))},Mt=function(e){xt.hasOwnProperty(e)&&xt[e]||(xt[e]=!0,Le(!1,"Unsupported vendor-prefixed style property %s. Did you mean %s?",e,e.charAt(0).toUpperCase()+e.slice(1)))},Dt=function(e,t){wt.hasOwnProperty(t)&&wt[t]||(wt[t]=!0,Le(!1,"Style property values shouldn't contain a semicolon. Try \"%s: %s\" instead.",e,t.replace(At,"")))},Ht=function(e){Ot||(Ot=!0,Le(!1,"`NaN` is an invalid value for the `%s` css style property.",e))},Ft=function(e){Rt||(Rt=!0,Le(!1,"`Infinity` is an invalid value for the `%s` css style property.",e))};kt=function(e,t){-1<e.indexOf("-")?Lt(e):vt.test(e)?Mt(e):At.test(t)&&Dt(e,t),"number"==typeof t&&(isNaN(t)?Ht(e,t):!isFinite(t)&&Ft(e,t))}}var Bt=kt,Wt={"aria-current":0,// state
