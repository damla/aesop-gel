...
return null;if("number"==typeof e.tag&&he(!1,"Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case ye:return"Fragment";case _e:return"Portal";case Ee:return"Profiler";case be:return"StrictMode";case ve:return"Suspense";case Se:return"SuspenseList";}if("object"===_typeof2(e))switch(e.$$typeof){case Te:return"Context.Consumer";case Ce:return"Context.Provider";case Ne:return n(e,e.render,"ForwardRef");case Ie:return o(e.type);case xe:{var a=t(e);if(a)return o(a);break}}return null}/**
...
// render's.
var s=r.action;pt=!0,i=e(i,s),pt=!1,r=r.next}while(null!==r);return dt.memoizedState=i,[i,o]}}return[dt.memoizedState,o]}pt=!0;var d;d=e===L?"function"==typeof t?t():t:void 0===a?t:a(t),pt=!1,dt.memoizedState=d;var u=dt.queue={last:null,dispatch:null},c=u.dispatch=B.bind(null,rt,u);return[dt.memoizedState,c]}function D(e,t){rt=S(),dt=w();var a=void 0===t?null:t;if(null!==dt){var n=dt.memoizedState;if(null!==n&&null!==a){var o=n[1];if(I(a,o))return n[0]}}pt=!0;var l=e();return pt=!1,dt.memoizedState=[l,a],l}function H(e){rt=S(),dt=w();var t=dt.memoizedState;if(null===t){var a={current:e};return Object.seal(a),dt.memoizedState=a,a}return t}function B(e,t,a){if(!(ft<25))throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(e===rt){ct=!0;var n={action:a,next:null};null===mt&&(mt=new Map);var o=mt.get(t);if(void 0===o)mt.set(t,n);else{// Append the update to the end of the list.
 ...
 * is converted to `-ms-`.
 */function G(e){return e.replace(xt,"-$1").toLowerCase().replace(wt,"-ms-")}function X(e,t){if(-1===e.indexOf("-"))return"string"==typeof t.is;return"annotation-xml"!==e&&"color-profile"!==e&&"font-face"!==e&&"font-face-src"!==e&&"font-face-uri"!==e&&"font-face-format"!==e&&"font-face-name"!==e&&"missing-glyph"!==e}function q(e,t){if(Zt.call(Xt,t)&&Xt[t])return!0;if(Yt.test(t)){var a="aria-"+t.slice(4).toLowerCase(),n=Gt.hasOwnProperty(a)?a:null;// If this is an aria-* attribute, but is not listed in the known DOM
...
function n(n,l){var r=ae(l),s=d(l,t,a,r),u=[],c=!1,m={isMounted:function isMounted(){return!1},enqueueForceUpdate:function enqueueForceUpdate(e){if(null===u)return te(e,"forceUpdate"),null},enqueueReplaceState:function enqueueReplaceState(e,t){c=!0,u=[t]},enqueueSetState:function enqueueSetState(e,t){return null===u?(te(e,"setState"),null):void u.push(t)}},f;if(!r){if(l.prototype&&"function"==typeof l.prototype.render){var p=o(l)||"Unknown";Ia[p]||(he(!1,"The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.",p,p),Ia[p]=!0)}if(A({}),f=l(n.props,s,m),f=O(l,n.props,f,s),null==f||null==f.render)return e=f,void re(e,l);{var h=o(l)||"Unknown";xa[h]||(he(!1,"The <%s /> component appears to be a function component that returns a class instance. Change %s to a class that extends React.Component instead. If you can't use a class try assigning the prototype on the function as a workaround. `%s.prototype = React.Component.prototype`. Don't use an arrow function since it cannot be called with `new` by React.",h,h,h),xa[h]=!0)}}else if(f=new l(n.props,s,m),"function"==typeof l.getDerivedStateFromProps){if(null===f.state||void 0===f.state){var g=o(l)||"Unknown";Oa[g]||(he(!1,"`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.",g,null===f.state?"null":"undefined",g),Oa[g]=!0)}var _=l.getDerivedStateFromProps.call(null,n.props,f.state);if(void 0===_){var y=o(l)||"Unknown";Aa[y]||(he(!1,"%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.",y),Aa[y]=!0)}null!=_&&(f.state=ue({},f.state,_))}f.props=n.props,f.context=s,f.updater=m;var b=f.state;if(void 0===b&&(f.state=b=null),"function"==typeof f.UNSAFE_componentWillMount||"function"==typeof f.componentWillMount){if("function"==typeof f.componentWillMount){if(!0!==f.componentWillMount.__suppressDeprecationWarning){var E=o(l)||"Unknown";wa[E]||(De(!1,// keep this warning in sync with ReactStrictModeWarning.js
...
"function"!=typeof l.getDerivedStateFromProps&&f.componentWillMount()}if("function"==typeof f.UNSAFE_componentWillMount&&"function"!=typeof l.getDerivedStateFromProps&&f.UNSAFE_componentWillMount(),u.length){var C=u,T=c;if(u=null,c=!1,T&&1===C.length)f.state=C[0];else{for(var k=T?C[0]:f.state,N=!0,v=T?1:0;v<C.length;v++){var S=C[v],I="function"==typeof S?S.call(f,k,n.props,s):S;null!=I&&(N?(N=!1,k=ue({},k,I)):ue(k,I))}f.state=k}}else u=null}e=f.render(),void 0===e&&f.render._isMockFunction&&(e=null),re(e,l);var x;{if("function"==typeof f.getChildContext){var w=l.childContextTypes;if("object"===_typeof2(w)){for(var P in x=f.getChildContext(),x)if(!(P in w))throw Error((o(l)||"Unknown")+".getChildContext(): key \""+P+"\" is not defined in childContextTypes.");}else he(!1,"%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().",o(l)||"Unknown")}x&&(t=ue({},t,x))}}for(;ce.isValidElement(e);){// Safe because we just checked it's an element.
...
fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},It=["Webkit","ms","Moz","O"];Object.keys(St).forEach(function(e){It.forEach(function(t){St[j(t,e)]=St[e]})});var xt=/([A-Z])/g,wt=/^ms-/,At=function(){};{// 'msTransform' is correct, but the other prefixes should be capitalized
...
void 0===I._context?I!==I.Consumer&&!ba&&(ba=!0,Re(!1,"Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?")):I=I._context;var x=r.props,w=this.threadID;s(I,w);var P=I[w],R=da(x.children(P)),L={type:r,domNamespace:n,children:R,childIndex:0,context:t,footer:""};return L.debugElementStack=[],this.stack.push(L),""}// eslint-disable-next-line-no-fallthrough
