"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=void 0;var _rollupPluginBabelHelpers903e1a=require("./_rollupPluginBabelHelpers-903e1a66.js"),_react=_interopRequireWildcard(require("react")),_propTypes=_interopRequireDefault(require("prop-types")),_classnames=_interopRequireDefault(require("classnames")),_Button=_interopRequireDefault(require("./components/Button.js")),_reactSlick=_interopRequireDefault(require("react-slick")),_crypto=_interopRequireDefault(require("crypto")),_Heading=_interopRequireDefault(require("./components/Heading.js")),_reactTransitionGroup=require("react-transition-group"),_reactDom=_interopRequireDefault(require("react-dom"));function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _getRequireWildcardCache(){if("function"!=typeof WeakMap)return null;var e=new WeakMap;return _getRequireWildcardCache=function(){return e},e}function _interopRequireWildcard(e){if(e&&e.__esModule)return e;if(null===e||"object"!==_typeof2(e)&&"function"!=typeof e)return{default:e};var t=_getRequireWildcardCache();if(t&&t.has(e))return t.get(e);var n={},i=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var a in e)if(Object.prototype.hasOwnProperty.call(e,a)){var d=i?Object.getOwnPropertyDescriptor(e,a):null;d&&(d.get||d.set)?Object.defineProperty(n,a,d):n[a]=e[a]}return n["default"]=e,t&&t.set(e,n),n}function _typeof2(e){"@babel/helpers - typeof";return _typeof2="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_typeof2(e)}/**
...
return E=e,h=setTimeout(o,t),g?i(e):p}function d(e){var n=e-I,i=e-E,a=t-n;return O?nativeMin(a,f-i):a}function l(e){var n=e-I,i=e-E;// Either this is the first call, activity has stopped and we're at the
...
CONFIRMATION_ACCOUNT_BUTTON:"CONFIRMATION_ACCOUNT_BUTTON"},constants={BREAKPOINTS:BREAKPOINTS,HTML:HTML,HYPERLINK_STYLE_TYPES:HYPERLINK_STYLE_TYPES,KEYBOARD_CODES:KEYBOARD_CODES,LABELS:LABELS,TEST_REFS:TEST_REFS},IS_MOBILE="(max-width: ".concat(BREAKPOINTS.MEDIUM.MIN_WIDTH,"px)"),IS_MOBILE_OR_TABLET="(max-width: ".concat(BREAKPOINTS.LARGE.MIN_WIDTH,"px)"),LARGE=BREAKPOINTS.LARGE,MEDIUM=BREAKPOINTS.MEDIUM,SMALL=BREAKPOINTS.SMALL,CONSTRAINT_KEYS={MIN_WIDTH:"minWidth",VIEWPORT:"viewport"},constraints=[(_ref={},(0,_rollupPluginBabelHelpers903e1a._)(_ref,CONSTRAINT_KEYS.MIN_WIDTH,SMALL.MIN_WIDTH),(0,_rollupPluginBabelHelpers903e1a._)(_ref,CONSTRAINT_KEYS.VIEWPORT,SMALL.VIEWPORT),_ref),(_ref2={},(0,_rollupPluginBabelHelpers903e1a._)(_ref2,CONSTRAINT_KEYS.MIN_WIDTH,MEDIUM.MIN_WIDTH),(0,_rollupPluginBabelHelpers903e1a._)(_ref2,CONSTRAINT_KEYS.VIEWPORT,MEDIUM.VIEWPORT),_ref2),(_ref3={},(0,_rollupPluginBabelHelpers903e1a._)(_ref3,CONSTRAINT_KEYS.MIN_WIDTH,LARGE.MIN_WIDTH),(0,_rollupPluginBabelHelpers903e1a._)(_ref3,CONSTRAINT_KEYS.VIEWPORT,LARGE.VIEWPORT),_ref3)],constraintsByViewport={};constraints.forEach(function(e){constraintsByViewport[e.viewport]=e});for(var getViewportForWidth=function(e){for(var t=constraints.length-1;0<=t&&e<constraints[t].minWidth;)t--;return constraints[t].viewport},ascertainIsMobileOrTablet=function(){return"undefined"!=typeof window&&window.matchMedia(IS_MOBILE_OR_TABLET).matches},ascertainIsMobile=function(){return"undefined"!=typeof window&&window.matchMedia(IS_MOBILE).matches},viewports={CONSTRAINT_KEYS:CONSTRAINT_KEYS,constraints:constraints,constraintsByViewport:constraintsByViewport,getViewportForWidth:getViewportForWidth,ascertainIsMobile:ascertainIsMobile,ascertainIsMobileOrTablet:ascertainIsMobileOrTablet},rng=function(){return _crypto["default"].randomBytes(16)},byteToHex=[],i=0;256>i;++i)byteToHex[i]=(i+256).toString(16).substr(1);function bytesToUuid(e,t){var n=t||0,a=byteToHex;// join used to fix memory issue caused by concatenation: https://bugs.chromium.org/p/v8/issues/detail?id=3175#c4
...
var _=d.get(e);if(_&&d.get(t))return _==t;var r=-1,u=!0,c=n&COMPARE_UNORDERED_FLAG?new _SetCache:void 0;// Ignore non-index properties.
for(d.set(e,t),d.set(t,e);++r<o;){var m=e[r],f=t[r];if(i)var p=l?i(f,m,r,t,e,d):i(m,f,r,e,t,d);if(void 0!==p){if(p)continue;u=!1;break}// Recursively compare arrays (susceptible to call stack limits).
if(c){if(!_arraySome(t,function(e,t){if(!_cacheHas(c,t)&&(m===e||a(m,e,n,i,d)))return c.push(t)})){u=!1;break}}else if(!(m===f||a(m,f,n,i,d))){u=!1;break}}return d["delete"](e),d["delete"](t),u}var _equalArrays=equalArrays,Uint8Array=_root.Uint8Array,_Uint8Array=Uint8Array;/** Built-in value references. */ /**
...
var _=l.get(e);if(_)return _==t;i|=COMPARE_UNORDERED_FLAG$1,l.set(e,t);var r=_equalArrays(o(e),o(t),i,a,d,l);return l["delete"](e),r;case symbolTag$1:if(symbolValueOf)return symbolValueOf.call(e)==symbolValueOf.call(t);}return!1}var _equalByTag=equalByTag;/**
 ...
 * @param {Object} [stack] Tracks traversed `object` and `other` objects.
 * @returns {boolean} Returns `true` if the objects are equivalent, else `false`.
 */function baseIsEqualDeep(e,t,n,i,a,d){var l=isArray_1(e),o=isArray_1(t),s=l?arrayTag$1:_getTag(e),_=o?arrayTag$1:_getTag(t);s=s==argsTag$2?objectTag$2:s,_=_==argsTag$2?objectTag$2:_;var r=s==objectTag$2,u=_==objectTag$2,c=s==_;if(c&&isBuffer_1(e)){if(!isBuffer_1(t))return!1;l=!0,r=!1}if(c&&!r)return d||(d=new _Stack),l||isTypedArray_1(e)?_equalArrays(e,t,n,i,a,d):_equalByTag(e,t,s,n,i,a,d);if(!(n&COMPARE_PARTIAL_FLAG$3)){var m=r&&hasOwnProperty$8.call(e,"__wrapped__"),f=u&&hasOwnProperty$8.call(t,"__wrapped__");if(m||f){var p=m?e.value():e,h=f?t.value():t;return d||(d=new _Stack),a(p,h,n,i,d)}}return!!c&&(d||(d=new _Stack),_equalObjects(e,t,n,i,a,d))}var _baseIsEqualDeep=baseIsEqualDeep;/**
 ...
 */function baseIsMatch(e,t,n,i){var a=n.length,d=a,l=!i;if(null==e)return!d;for(e=Object(e);a--;){var o=n[a];if(l&&o[2]?o[1]!==e[o[0]]:!(o[0]in e))return!1}for(;++a<d;){o=n[a];var s=o[0],_=e[s],r=o[1];if(!(l&&o[2])){var u=new _Stack;if(i)var c=i(_,r,s,e,t,u);if(void 0===c?!_baseIsEqual(r,_,COMPARE_PARTIAL_FLAG$4|COMPARE_UNORDERED_FLAG$2,i,u):!c)return!1}else if(void 0===_&&!(s in e))return!1}return!0}var _baseIsMatch=baseIsMatch;/**
