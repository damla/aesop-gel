...
var _=i.get(e);if(_&&i.get(t))return _==t;var f=!0;i.set(e,t),i.set(t,e);for(var h=d;++m<o;){c=s[m];var p=e[c],g=t[c];if(l)var E=d?l(g,p,c,t,e,i):l(p,g,c,e,t,i);// Recursively compare objects (susceptible to call stack limits).
