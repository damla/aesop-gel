...
// render's.
var s=r.action;pt=!0,i=e(i,s),pt=!1,r=r.next}while(null!==r);return dt.memoizedState=i,[i,o]}}return[dt.memoizedState,o]}pt=!0;var d;d=e===L?"function"==typeof t?t():t:void 0===a?t:a(t),pt=!1,dt.memoizedState=d;var u=dt.queue={last:null,dispatch:null},c=u.dispatch=B.bind(null,rt,u);return[dt.memoizedState,c]}function D(e,t){rt=S(),dt=A();var a=void 0===t?null:t;if(null!==dt){var n=dt.memoizedState;if(null!==n&&null!==a){var o=n[1];if(I(a,o))return n[0]}}pt=!0;var l=e();return pt=!1,dt.memoizedState=[l,a],l}function H(e){rt=S(),dt=A();var t=dt.memoizedState;if(null===t){var a={current:e};return Object.seal(a),dt.memoizedState=a,a}return t}function B(e,t,a){if(!(ft<25))throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(e===rt){ct=!0;var n={action:a,next:null};null===mt&&(mt=new Map);var o=mt.get(t);if(void 0===o)mt.set(t,n);else{// Append the update to the end of the list.
...
"function"!=typeof l.getDerivedStateFromProps&&f.componentWillMount()}if("function"==typeof f.UNSAFE_componentWillMount&&"function"!=typeof l.getDerivedStateFromProps&&f.UNSAFE_componentWillMount(),u.length){var C=u,T=c;if(u=null,c=!1,T&&1===C.length)f.state=C[0];else{for(var k=T?C[0]:f.state,N=!0,v=T?1:0;v<C.length;v++){var S=C[v],I="function"==typeof S?S.call(f,k,n.props,s):S;null!=I&&(N?(N=!1,k=ue({},k,I)):ue(k,I))}f.state=k}}else u=null}e=f.render(),void 0===e&&f.render._isMockFunction&&(e=null),re(e,l);var x;{if("function"==typeof f.getChildContext){var A=l.childContextTypes;if("object"===_typeof2(A)){for(var P in x=f.getChildContext(),x)if(!(P in A))throw Error((o(l)||"Unknown")+".getChildContext(): key \""+P+"\" is not defined in childContextTypes.");}else he(!1,"%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().",o(l)||"Unknown")}x&&(t=ue({},t,x))}}for(;ce.isValidElement(e);){// Safe because we just checked it's an element.
...
Ft(e.replace(Pt,"ms-"))))},Ut=function(e){Mt.hasOwnProperty(e)&&Mt[e]||(Mt[e]=!0,Re(!1,"Unsupported vendor-prefixed style property %s. Did you mean %s?",e,e.charAt(0).toUpperCase()+e.slice(1)))},Vt=function(e,t){Dt.hasOwnProperty(t)&&Dt[t]||(Dt[t]=!0,Re(!1,"Style property values shouldn't contain a semicolon. Try \"%s: %s\" instead.",e,t.replace(Lt,"")))},zt=function(e){Ht||(Ht=!0,Re(!1,"`NaN` is an invalid value for the `%s` css style property.",e))},jt=function(e){Bt||(Bt=!0,Re(!1,"`Infinity` is an invalid value for the `%s` css style property.",e))};wt=function(e,t){-1<e.indexOf("-")?Wt(e):Ot.test(e)?Ut(e):Lt.test(t)&&Vt(e,t),"number"==typeof t&&(isNaN(t)?zt(e,t):!isFinite(t)&&jt(e,t))}}var Kt=wt,Gt={"aria-current":0,// state
...
void 0===I._context?I!==I.Consumer&&!ba&&(ba=!0,Re(!1,"Rendering <Context> directly is not supported and will be removed in a future major release. Did you mean to render <Context.Consumer> instead?")):I=I._context;var x=r.props,A=this.threadID;s(I,A);var P=I[A],R=da(x.children(P)),L={type:r,domNamespace:n,children:R,childIndex:0,context:t,footer:""};return L.debugElementStack=[],this.stack.push(L),""}// eslint-disable-next-line-no-fallthrough
