...
var _=i.get(e);if(_&&i.get(t))return _==t;var f=!0;i.set(e,t),i.set(t,e);for(var h=s;++m<d;){c=o[m];var p=e[c],g=t[c];if(l)var E=s?l(g,p,c,t,e,i):l(p,g,c,e,t,i);// Recursively compare objects (susceptible to call stack limits).
if(void 0===E?!(p===g||n(p,g,a,l,i)):!E){f=!1;break}h||(h="constructor"==c)}if(f&&!h){var T=e.constructor,y=t.constructor;// Non `Object` object instances with different constructors are not equal.
