...
return null;if("number"==typeof e.tag&&be(!1,"Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case Ie:return"ConcurrentMode";case Te:return"Fragment";case Ce:return"Portal";case ke:return"Profiler";case Ne:return"StrictMode";case xe:return"Suspense";}if("object"===_typeof2(e))switch(e.$$typeof){case ve:return"Context.Consumer";case Se:return"Context.Provider";case Ae:return n(e,e.render,"ForwardRef");case we:return l(e.type);case Oe:{var t=a(e);if(t)return l(t)}}return null}function o(e,t){var a=e.contextTypes;if(!a)return Be;var n={};for(var l in a)n[l]=t[l];return n}function r(e,t,a){he(e,t,a,"Component",He.getCurrentStack)}function s(e,t){// If we don't have enough slots in this context to store this threadID,
...
e[a]=e._currentValue2,e._threadCount=a+1}function d(e,t,a){var n=e.contextType;if("object"===_typeof2(n)&&null!==n){if(n.$$typeof!==ve){var i=l(e)||"Component";Fe[i]||(Fe[i]=!0,be(!1,"%s defines an invalid contextType. contextType should point to the Context object returned by React.createContext(). Did you accidentally pass the Context.Provider instead?",i))}return s(n,a),n[a]}var d=o(e,t);return e.contextTypes&&r(e.contextTypes,d,"context"),d}// Allocates a new index for each request. Tries to stay as compact as possible so that these
...
// render's.
var s=r.action;st=!0,o=e(o,s),st=!1,r=r.next}while(null!==r);return nt.memoizedState=o,[o,l]}}return[nt.memoizedState,l]}st=!0;var d;d=e===L?"function"==typeof t?t():t:void 0===a?t:a(t),st=!1,nt.memoizedState=d;var u=nt.queue={last:null,dispatch:null},c=u.dispatch=F.bind(null,tt,u);return[nt.memoizedState,c]}function D(e,t){tt=v(),nt=x();var a=void 0===t?null:t;if(null!==nt){var n=nt.memoizedState;if(null!==n&&null!==a){var l=n[1];if(I(a,l))return n[0]}}st=!0;var i=e();return st=!1,nt.memoizedState=[i,a],i}function H(e){tt=v(),nt=x();var t=nt.memoizedState;if(null===t){var a={current:e};return Object.seal(a),nt.memoizedState=a,a}return t}function F(e,a,n){if(25>rt?void 0:t(!1,"Too many re-renders. React limits the number of renders to prevent an infinite loop."),e===tt){it=!0;var l={action:n,next:null};null===ot&&(ot=new Map);var i=ot.get(a);if(void 0===i)ot.set(a,l);else{// Append the update to the end of the list.
 ...
 * is converted to `-ms-`.
 */function G(e){return e.replace(Tt,"-$1").toLowerCase().replace(Nt,"-ms-")}function X(e,t){if(-1===e.indexOf("-"))return"string"==typeof t.is;return"annotation-xml"!==e&&"color-profile"!==e&&"font-face"!==e&&"font-face-src"!==e&&"font-face-uri"!==e&&"font-face-format"!==e&&"font-face-name"!==e&&"missing-glyph"!==e}function q(e,t){if(jt.call(Ut,t)&&Ut[t])return!0;if(zt.test(t)){var a="aria-"+t.slice(4).toLowerCase(),n=Wt.hasOwnProperty(a)?a:null;// If this is an aria-* attribute, but is not listed in the known DOM
...
if(t!==n)return Le(!1,"Invalid ARIA attribute `%s`. Did you mean `%s`?",t,n),Ut[t]=!0,!0}if(Vt.test(t)){var l=t.toLowerCase(),i=Wt.hasOwnProperty(l)?l:null;// If this is an aria-* attribute, but is not listed in the known DOM
// DOM properties, then it is an invalid aria-* attribute.
...
function ee(e){Ia.hasOwnProperty(e)||(va.test(e)?void 0:t(!1,"Invalid tag: %s",e),Ia[e]=!0)}function te(e){var t="",a="";for(var n in e)if(e.hasOwnProperty(n)){var l=0===n.indexOf("--"),i=e[n];l||Bt(n,i),null!=i&&(t+=a+xa(n)+":",t+=K(n,i,l),a=";")}return t||null}function ae(e,t){{var a=e.constructor,n=a&&l(a)||"ReactClass",i=n+"."+t;if(Ea[i])return;be(!1,"%s(...): Can only update a mounting component. This usually means you called %s() outside componentWillMount() on the server. This is a no-op.\n\nPlease check the code for the %s component.",t,t,n),Ea[i]=!0}}function ne(e){return e.prototype&&e.prototype.isReactComponent}function le(e){var t=e.dangerouslySetInnerHTML;if(!(null!=t)){var a=e.children;if("string"==typeof a||"number"==typeof a)return E(a)}else if(null!=t.__html)return t.__html;return null}function ie(e){if(!pe.isValidElement(e))return na(e);var t=e;if(t.type!==Te)return[t];var a=t.props.children;if(!pe.isValidElement(a))return na(a);return[a]}function oe(e){if(void 0===e||null===e)return e;var t="";// Flatten children and warn if they aren't strings or numbers;
...
// bytes.
return l?o:(i&&(o+=" "+T()),o)}function se(e,a){e===void 0&&t(!1,"%s(...): Nothing was returned from render. This usually means a return statement is missing. Or, to render nothing, return null.",l(a)||"Component")}function de(e,a,n){// Extra closure so queue and replace can be captured properly
function i(o,r){var s=d(r,a,n),u=[],c=!1,m={isMounted:function isMounted(){return!1},enqueueForceUpdate:function enqueueForceUpdate(e){if(null===u)return ae(e,"forceUpdate"),null},enqueueReplaceState:function enqueueReplaceState(e,t){c=!0,u=[t]},enqueueSetState:function enqueueSetState(e,t){return null===u?(ae(e,"setState"),null):void u.push(t)}},f=void 0;if(!ne(r)){if(r.prototype&&"function"==typeof r.prototype.render){var p=l(r)||"Unknown";Ca[p]||(be(!1,"The <%s /> component appears to have a render method, but doesn't extend React.Component. This is likely to cause errors. Change %s to extend React.Component instead.",p,p),Ca[p]=!0)}if(w({}),f=r(o.props,s,m),f=O(r,o.props,f,s),null==f||null==f.render)return e=f,void se(e,r)}else if(f=new r(o.props,s,m),"function"==typeof r.getDerivedStateFromProps){if(null===f.state||void 0===f.state){var h=l(r)||"Unknown";Na[h]||(be(!1,"`%s` uses `getDerivedStateFromProps` but its initial state is %s. This is not recommended. Instead, define the initial state by assigning an object to `this.state` in the constructor of `%s`. This ensures that `getDerivedStateFromProps` arguments have a consistent shape.",h,null===f.state?"null":"undefined",h),Na[h]=!0)}var g=r.getDerivedStateFromProps.call(null,o.props,f.state);if(void 0===g){var _=l(r)||"Unknown";Ta[_]||(be(!1,"%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. You have returned undefined.",_),Ta[_]=!0)}null!=g&&(f.state=fe({},f.state,g))}f.props=o.props,f.context=s,f.updater=m;var y=f.state;if(void 0===y&&(f.state=y=null),"function"==typeof f.UNSAFE_componentWillMount||"function"==typeof f.componentWillMount)if("function"==typeof f.componentWillMount&&"function"!=typeof r.getDerivedStateFromProps&&f.componentWillMount(),"function"==typeof f.UNSAFE_componentWillMount&&"function"!=typeof r.getDerivedStateFromProps&&f.UNSAFE_componentWillMount(),u.length){var b=u,E=c;if(u=null,c=!1,E&&1===b.length)f.state=b[0];else{for(var C=E?b[0]:f.state,T=!0,N=E?1:0;N<b.length;N++){var k=b[N],S="function"==typeof k?k.call(f,C,o.props,s):k;null!=S&&(T?(T=!1,C=fe({},C,S)):fe(C,S))}f.state=C}}else u=null;e=f.render(),void 0===e&&f.render._isMockFunction&&(e=null),se(e,r);var v;if("function"==typeof f.getChildContext){var I=r.childContextTypes;if("object"===_typeof2(I))for(var A in v=f.getChildContext(),v)A in I?void 0:t(!1,"%s.getChildContext(): key \"%s\" is not defined in childContextTypes.",l(r)||"Unknown",A);else be(!1,"%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().",l(r)||"Unknown")}v&&(a=fe({},a,v))}for(;pe.isValidElement(e);){// Safe because we just checked it's an element.
...
),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var t=e[0],a=e[1];$e[t]=new y(t,Ve,!1,// mustUseProperty
a,// attributeName
null)}// attributeNamespace
),["contentEditable","draggable","spellCheck","value"].forEach(function(e){$e[e]=new y(e,ze,!1,// mustUseProperty
e.toLowerCase(),// attributeName
null)}// attributeNamespace
),["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){$e[e]=new y(e,ze,!1,// mustUseProperty
e,// attributeName
null)}// attributeNamespace
...
e.toLowerCase(),// attributeName
null)}// attributeNamespace
);var Qe=/[\-\:]([a-z])/g,Je=function(e){return e[1].toUpperCase()};["accent-height","alignment-baseline","arabic-form","baseline-shift","cap-height","clip-path","clip-rule","color-interpolation","color-interpolation-filters","color-profile","color-rendering","dominant-baseline","enable-background","fill-opacity","fill-rule","flood-color","flood-opacity","font-family","font-size","font-size-adjust","font-stretch","font-style","font-variant","font-weight","glyph-name","glyph-orientation-horizontal","glyph-orientation-vertical","horiz-adv-x","horiz-origin-x","image-rendering","letter-spacing","lighting-color","marker-end","marker-mid","marker-start","overline-position","overline-thickness","paint-order","panose-1","pointer-events","rendering-intent","shape-rendering","stop-color","stop-opacity","strikethrough-position","strikethrough-thickness","stroke-dasharray","stroke-dashoffset","stroke-linecap","stroke-linejoin","stroke-miterlimit","stroke-opacity","stroke-width","text-anchor","text-decoration","text-rendering","underline-position","underline-thickness","unicode-bidi","unicode-range","units-per-em","v-alphabetic","v-hanging","v-ideographic","v-mathematical","vector-effect","vert-adv-y","vert-origin-x","vert-origin-y","word-spacing","writing-mode","xmlns:xlink","x-height"].forEach(function(e){var t=e.replace(Qe,Je);$e[t]=new y(t,Ve,!1,// mustUseProperty
e,null)}// attributeNamespace
),["xlink:actuate","xlink:arcrole","xlink:href","xlink:role","xlink:show","xlink:title","xlink:type"].forEach(function(e){var t=e.replace(Qe,Je);$e[t]=new y(t,Ve,!1,// mustUseProperty
e,"http://www.w3.org/1999/xlink")}),["xml:base","xml:lang","xml:space"].forEach(function(e){var t=e.replace(Qe,Je);$e[t]=new y(t,Ve,!1,// mustUseProperty
e,"http://www.w3.org/XML/1998/namespace")}),$e.tabIndex=new y("tabIndex",Ve,!1,// mustUseProperty
"tabindex",// attributeName
null);// code copied and modified from escape-html
/**
 * Module variables.
 * @private
 */var et=/["'&<>]/,tt=null,at=null,nt=null,lt=!1,it=!1,ot=null,rt=0,st=!1,dt=void 0,ut=0,ct={readContext:R,useContext:P,useMemo:D,useReducer:M,useRef:H,useState:function(e){return dt="useState",M(L,// useReducer has a special case to support lazy useState initializers
...
fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},Ct=["Webkit","ms","Moz","O"];Object.keys(Et).forEach(function(e){Ct.forEach(function(t){Et[j(t,e)]=Et[e]})});var Tt=/([A-Z])/g,Nt=/^ms-/,kt=function(){};{// 'msTransform' is correct, but the other prefixes should be capitalized
var St=/^(?:webkit|moz|o)[A-Z]/,vt=/^-ms-/,It=/-(.)/g,At=/;\s*$/,xt={},wt={},Ot=!1,Rt=!1,Pt=function(e){return e.replace(It,function(e,t){return t.toUpperCase()})},Lt=function(e){xt.hasOwnProperty(e)&&xt[e]||(xt[e]=!0,Le(!1,"Unsupported style property %s. Did you mean %s?",e,// As Andi Smith suggests
// (http://www.andismith.com/blog/2012/02/modernizr-prefixed/), an `-ms` prefix
// is converted to lowercase `ms`.
Pt(e.replace(vt,"ms-"))))},Mt=function(e){xt.hasOwnProperty(e)&&xt[e]||(xt[e]=!0,Le(!1,"Unsupported vendor-prefixed style property %s. Did you mean %s?",e,e.charAt(0).toUpperCase()+e.slice(1)))},Dt=function(e,t){wt.hasOwnProperty(t)&&wt[t]||(wt[t]=!0,Le(!1,"Style property values shouldn't contain a semicolon. Try \"%s: %s\" instead.",e,t.replace(At,"")))},Ht=function(e){Ot||(Ot=!0,Le(!1,"`NaN` is an invalid value for the `%s` css style property.",e))},Ft=function(e){Rt||(Rt=!0,Le(!1,"`Infinity` is an invalid value for the `%s` css style property.",e))};kt=function(e,t){-1<e.indexOf("-")?Lt(e):St.test(e)?Mt(e):At.test(t)&&Dt(e,t),"number"==typeof t&&(isNaN(t)?Ht(e,t):!isFinite(t)&&Ft(e,t))}}var Bt=kt,Wt={"aria-current":0,// state
...
"aria-activedescendant":0,"aria-colcount":0,"aria-colindex":0,"aria-colspan":0,"aria-controls":0,"aria-describedby":0,"aria-errormessage":0,"aria-flowto":0,"aria-labelledby":0,"aria-owns":0,"aria-posinset":0,"aria-rowcount":0,"aria-rowindex":0,"aria-rowspan":0,"aria-setsize":0},Ut={},Vt=new RegExp("^(aria)-["+Ge+"]*$"),zt=new RegExp("^(aria)[A-Z]["+Ge+"]*$"),jt=Object.prototype.hasOwnProperty,Kt=!1,Gt={},Xt={},qt={// HTML
...
for(var e=la[la.length-1],t="",a=e.length-1;0<=a;a--)for(var n=e[a],l=n.debugElementStack,o=l.length-1;0<=o;o--)t+=da(l[o]);return t};var ha=!1,ga=!1,_a=!1,ya=!1,ba=!1,Ea={},Ca={},Ta={},Na={},ka=["value","defaultValue"],Sa={listing:!0,pre:!0,textarea:!0},va=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,Ia={},Aa={},xa=function(e){if(Aa.hasOwnProperty(e))return Aa[e];var t=G(e);return Aa[e]=t,t},wa=Object.prototype.hasOwnProperty,Oa={children:null,dangerouslySetInnerHTML:null,suppressContentEditableWarning:null,suppressHydrationWarning:null},Ra=function(){// DEV-only
...
for(var l=[""],i=!1;l[0].length<e;){if(0===this.stack.length){this.exhausted=!0,m(this.threadID);break}var o=this.stack[this.stack.length-1];if(i||o.childIndex>=o.children.length){var r=o.footer;if(""!==r&&(this.previousWasTextNode=!1),this.stack.pop(),"select"===o.type)this.currentSelectValue=null;else if(null!=o.type&&null!=o.type.type&&o.type.type.$$typeof===Se){var s=o.type;this.popProvider(s)}else if(o.type===xe){this.suspenseDepth--;var d=l.pop();if(i){i=!1;// If rendering was suspended at this boundary, render the fallbackFrame
...
var d=o.$$typeof;d===Ce?t(!1,"Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render."):void 0,t(!1,"Unknown element-like object type: %s. This is likely a bug in React. Please file an issue.",d.toString())}var u=na(o),c={type:null,domNamespace:n,children:u,childIndex:0,context:a,footer:""};return c.debugElementStack=[],this.stack.push(c),""}var m=o,f=m.type;if("string"==typeof f)return this.renderDOM(m,a,n);switch(f){case Ne:case Ie:case ke:case Te:{var p=na(o.props.children),h={type:null,domNamespace:n,children:p,childIndex:0,context:a,footer:""};return h.debugElementStack=[],this.stack.push(h),""}case xe:t(!1,"ReactDOMServer does not yet support Suspense.");}if("object"===_typeof2(f)&&null!==f)switch(f.$$typeof){case Ae:{var g=o,_=void 0;w({}),_=f.render(g.props,g.ref),_=O(f.render,g.props,_,g.ref),_=na(_);var y={type:null,domNamespace:n,children:_,childIndex:0,context:a,footer:""};return y.debugElementStack=[],this.stack.push(y),""}case we:{var b=o,C=[pe.createElement(f.type,fe({ref:b.ref},b.props))],T={type:null,domNamespace:n,children:C,childIndex:0,context:a,footer:""};return T.debugElementStack=[],this.stack.push(T),""}case Se:{var N=o,k=N.props,S=na(k.children),v={type:N,domNamespace:n,children:S,childIndex:0,context:a,footer:""};return v.debugElementStack=[],this.pushProvider(N),this.stack.push(v),""}case ve:{var I=o.type;// The logic below for Context differs depending on PROD or DEV mode. In
...
for(var y=0;y<h.length;y++)if(""+h[y]===_){p=!0;break}}else p=""+h===_;r=fe({selected:void 0,children:void 0},r,{selected:p,children:g})}}ua(l,r),z(l,r);var b=re(e.type,l,r,o,this.makeStaticMarkup,1===this.stack.length),E="";_t.hasOwnProperty(l)?b+="/>":(b+=">",E="</"+e.type+">");var C=void 0,T=le(r);null==T?C=na(r.children):(C=[],Sa[l]&&"\n"===T.charAt(0)&&(b+="\n"),b+=T);var N={domNamespace:V(n,e.type),type:l,children:C,childIndex:0,context:a,footer:E};return N.debugElementStack=[],this.stack.push(N),this.previousWasTextNode=!1,b},e}(),Pa=function(e){function t(a,n){ue(this,t);var l=ce(this,e.call(this,{}));// Calls the stream.Readable(options) constructor. Consider exposing built-in
