...
return null;if("number"==typeof e.tag&&n("Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case Te:return"Fragment";case Ce:return"Portal";case Ne:return"Profiler";case ke:return"StrictMode";case we:return"Suspense";case xe:return"SuspenseList";}if("object"===_typeof2(e))switch(e.$$typeof){case ve:return"Context.Consumer";case Se:return"Context.Provider";case Ae:return s(e,e.render,"ForwardRef");case Oe:return d(e.type);case Pe:return d(e.render);case Re:{var t=o(e);if(t)return d(t);break}}return null}function u(e,t,a){var n="";if(t){var l=t.fileName,i=l.replace(He,"");// In DEV, include code for a common special case:
