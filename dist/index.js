...
return null;if("number"==typeof e.tag&&n("Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case Ce:return"Fragment";case Te:return"Portal";case ke:return"Profiler";case Ne:return"StrictMode";case we:return"Suspense";case xe:return"SuspenseList";}if("object"===_typeof2(e))switch(e.$$typeof){case ve:return"Context.Consumer";case Se:return"Context.Provider";case Ae:return s(e,e.render,"ForwardRef");case Oe:return d(e.type);case Pe:return d(e.render);case Re:{var t=o(e);if(t)return d(t);break}}return null}function u(e,t,a){var n="";if(t){var l=t.fileName,i=l.replace(He,"");// In DEV, include code for a common special case:
 ...
 */function w(e,t){var a=C(e);if("style"!==e&&b(e,a,!1))return"";if(T(e,t,a,!1))return"";if(null!==a){var n=a.attributeName,l=a.type;return 3===l||4===l&&!0===t?n+"=\"\"":(a.sanitizeURL&&(t=""+t,k(t)),n+"="+I(t))}return y(e)?e+"="+I(t):""}/**
...
e,// attributeName
null,!1)}),[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var t=e[0],a=e[1];Qe[t]=new N(t,ze,!1,// mustUseProperty
a,// attributeName
...
// you'll need to set attributeName to name.toLowerCase()
// instead in the assignment below.
].forEach(function(e){var t=e.replace(Je,et);Qe[t]=new N(t,ze,!1,// mustUseProperty
...
e,"http://www.w3.org/XML/1998/namespace",!1)}),["tabIndex","crossOrigin"].forEach(function(e){Qe[e]=new N(e,ze,!1,// mustUseProperty
e.toLowerCase(),// attributeName
null,!1)});Qe.xlinkHref=new N("xlinkHref",ze,!1,// mustUseProperty
"xlink:href","http://www.w3.org/1999/xlink",!0),["src","href","action","formAction"].forEach(function(e){Qe[e]=new N(e,ze,!1,// mustUseProperty
e.toLowerCase(),// attributeName
...
"aria-activedescendant":0,"aria-colcount":0,"aria-colindex":0,"aria-colspan":0,"aria-controls":0,"aria-describedby":0,"aria-errormessage":0,"aria-flowto":0,"aria-labelledby":0,"aria-owns":0,"aria-posinset":0,"aria-rowcount":0,"aria-rowindex":0,"aria-rowspan":0,"aria-setsize":0},Vt={},zt=new RegExp("^(aria)-["+Xe+"]*$"),jt=new RegExp("^(aria)[A-Z]["+Xe+"]*$"),Gt=Object.prototype.hasOwnProperty,Kt=!1,Xt={},qt={},Yt={// HTML
...
for(var n=[""],l=!1;n[0].length<e;){if(0===this.stack.length){this.exhausted=!0,_(this.threadID);break}var i=this.stack[this.stack.length-1];if(l||i.childIndex>=i.children.length){var o=i.footer;if(""!==o&&(this.previousWasTextNode=!1),this.stack.pop(),"select"===i.type)this.currentSelectValue=null;else if(null!=i.type&&null!=i.type.type&&i.type.type.$$typeof===Se){var r=i.type;this.popProvider(r)}else if(i.type===we){this.suspenseDepth--;var s=n.pop();if(l){l=!1;// If rendering was suspended at this boundary, render the fallbackFrame
