...
// render's.
var s=r.action;pt=!0,o=e(o,s),pt=!1,r=r.next}while(null!==r);return dt.memoizedState=o,[o,l]}}return[dt.memoizedState,l]}pt=!0;var d;d=e===L?"function"==typeof t?t():t:void 0===a?t:a(t),pt=!1,dt.memoizedState=d;var u=dt.queue={last:null,dispatch:null},c=u.dispatch=B.bind(null,rt,u);return[dt.memoizedState,c]}function D(e,t){rt=S(),dt=A();var a=void 0===t?null:t;if(null!==dt){var n=dt.memoizedState;if(null!==n&&null!==a){var l=n[1];if(I(a,l))return n[0]}}pt=!0;var i=e();return pt=!1,dt.memoizedState=[i,a],i}function H(e){rt=S(),dt=A();var t=dt.memoizedState;if(null===t){var a={current:e};return Object.seal(a),dt.memoizedState=a,a}return t}function B(e,t,a){if(!(ft<25))throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(e===rt){ct=!0;var n={action:a,next:null};null===mt&&(mt=new Map);var l=mt.get(t);if(void 0===l)mt.set(t,n);else{// Append the update to the end of the list.
...
// bytes.
return l?o:(i&&(o+=" "+k()),o)}function re(e,t){if(e===void 0)throw Error((l(t)||"Component")+"(...): Nothing was returned from render. This usually means a return statement is missing. Or, to render nothing, return null.")}function se(e,t,a){// Extra closure so queue and replace can be captured properly
