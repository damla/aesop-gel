...
},it=null,ot=null,rt=null,st=!1,dt=!1,ut=null,ct=0,mt=!1,ft=0,pt={readContext:D,useContext:B,useMemo:U,useReducer:W,useRef:z,useState:function(e){return yt="useState",W(F,// useReducer has a special case to support lazy useState initializers
...
Lt(e.replace(/^-ms-/,"ms-"))))},Ht=function(e){wt.hasOwnProperty(e)&&wt[e]||(wt[e]=!0,n("Unsupported vendor-prefixed style property %s. Did you mean %s?",e,e.charAt(0).toUpperCase()+e.slice(1)))},Dt=function(e,t){Ot.hasOwnProperty(t)&&Ot[t]||(Ot[t]=!0,n("Style property values shouldn't contain a semicolon. Try \"%s: %s\" instead.",e,t.replace(xt,"")))},Bt=function(e){Pt||(Pt=!0,n("`NaN` is an invalid value for the `%s` css style property.",e))},Ft=function(e){Rt||(Rt=!0,n("`Infinity` is an invalid value for the `%s` css style property.",e))};At=function(e,t){-1<e.indexOf("-")?Mt(e):/^(?:webkit|moz|o)[A-Z]/.test(e)?Ht(e):xt.test(t)&&Dt(e,t),"number"==typeof t&&(isNaN(t)?Bt(e,t):!isFinite(t)&&Ft(e,t))}}var Wt=At,Ut={"aria-current":0,// state
