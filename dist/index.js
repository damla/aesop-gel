...
var m=l.get(e);if(m&&l.get(t))return m==t;var f=!0;l.set(e,t),l.set(t,e);for(var p=d;++c<s;){r=o[c];var I=e[r],g=t[r];if(i)var E=d?i(g,I,r,t,e,l):i(I,g,r,e,t,l);// Recursively compare objects (susceptible to call stack limits).
