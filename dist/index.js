...
// attributeNamespace
// attributeNamespace
/* canUseEventSystem */!1,o=void 0;try{for(var i=e[Symbol.iterator](),r;!(n=(r=i.next()).done)&&(a.push(r.value),!(t&&a.length===t));n=!0);}catch(e){l=!0,o=e}finally{try{n||null==i["return"]||i["return"]()}finally{if(l)throw o}}return a}}function _nonIterableSpread(){throw new TypeError("Invalid attempt to spread non-iterable instance")}function _nonIterableRest(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}// Unique ID creation requires a high quality random # generator.  In node.js
...
return null;if("number"==typeof e.tag&&he(!1,"Received an unexpected object in getComponentName(). This is likely a bug in React. Please file an issue."),"function"==typeof e)return e.displayName||e.name||null;if("string"==typeof e)return e;switch(e){case ye:return"Fragment";case _e:return"Portal";case Ee:return"Profiler";case be:return"StrictMode";case ve:return"Suspense";case Se:return"SuspenseList";}if("object"===_typeof2(e))switch(e.$$typeof){case Te:return"Context.Consumer";case Ce:return"Context.Provider";case Ne:return n(e,e.render,"ForwardRef");case Ie:return l(e.type);case xe:{var a=t(e);if(a)return l(a);break}}return null}/**
 ...
 * @return {string}
 * @public
 */function E(e){var t=""+e,a=ot.exec(t);if(!a)return t;var n="",l=0,o,i;for(i=a.index;i<t.length;i++){switch(t.charCodeAt(i)){case 34:o="&quot;";break;case 38:o="&amp;";break;case 39:o="&#x27;";// modified from escape-html; used to be '&#39'
 ...
 */function N(e,t){var a=_(e);if("style"!==e&&p(e,a,!1))return"";if(g(e,t,a,!1))return"";if(null!==a){var n=a.attributeName,l=a.type;return 3===l||4===l&&!0===t?n+"=\"\"":(a.sanitizeURL&&(t=""+t,b(t)),n+"="+T(t))}return f(e)?e+"="+T(t):""}/**
...
var o=mt.get(n);if(void 0!==o){mt["delete"](n);var i=dt.memoizedState,r=o;do{// Process this render phase update. We don't have to check the
// priority because it will always be the same as the current
// render's.
var s=r.action;pt=!0,i=e(i,s),pt=!1,r=r.next}while(null!==r);return dt.memoizedState=i,[i,l]}}return[dt.memoizedState,l]}pt=!0;var d;d=e===L?"function"==typeof t?t():t:void 0===a?t:a(t),pt=!1,dt.memoizedState=d;var u=dt.queue={last:null,dispatch:null},c=u.dispatch=B.bind(null,rt,u);return[dt.memoizedState,c]}function D(e,t){rt=S(),dt=A();var a=void 0===t?null:t;if(null!==dt){var n=dt.memoizedState;if(null!==n&&null!==a){var l=n[1];if(I(a,l))return n[0]}}pt=!0;var o=e();return pt=!1,dt.memoizedState=[o,a],o}function H(e){rt=S(),dt=A();var t=dt.memoizedState;if(null===t){var a={current:e};return Object.seal(a),dt.memoizedState=a,a}return t}function B(e,t,a){if(!(ft<25))throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(e===rt){ct=!0;var n={action:a,next:null};null===mt&&(mt=new Map);var l=mt.get(t);if(void 0===l)mt.set(t,n);else{// Append the update to the end of the list.
for(var o=l;null!==o.next;)o=o.next;o.next=n}}}function F(){}function W(e){ht=e}// Assumes there is no parent namespace.
 ...
 */function Q(e,t,a){X(e,t)||sa(e,t,a)}function J(e){if(!Ma.hasOwnProperty(e)){if(!La.test(e))throw Error("Invalid tag: "+e);Ma[e]=!0}}function ee(e){var t="",a="";for(var n in e)if(e.hasOwnProperty(n)){var l=0===n.indexOf("--"),o=e[n];l||Kt(n,o),null!=o&&(t+=a+(l?n:Ha(n))+":",t+=K(n,o,l),a=";")}return t||null}function te(e,t){{var a=e.constructor,n=a&&l(a)||"ReactClass",o=n+"."+t;if(Sa[o])return;he(!1,"%s(...): Can only update a mounting component. This usually means you called %s() outside componentWillMount() on the server. This is a no-op.\n\nPlease check the code for the %s component.",t,t,n),Sa[o]=!0}}function ae(e){return e.prototype&&e.prototype.isReactComponent}function ne(e){var t=e.dangerouslySetInnerHTML;if(!(null!=t)){var a=e.children;if("string"==typeof a||"number"==typeof a)return C(a)}else if(null!=t.__html)return t.__html;return null}function le(e){if(!ce.isValidElement(e))return da(e);var t=e;if(t.type!==ye)return[t];var a=t.props.children;if(!ce.isValidElement(a))return da(a);return[a]}function oe(e){if(void 0===e||null===e)return e;var t="";// Flatten children and warn if they aren't strings or numbers;
// invalid types are ignored.
return ce.Children.forEach(e,function(e){null==e||(t+=e,!va&&"string"!=typeof e&&"number"!=typeof e&&(va=!0,Pe(!1,"Only strings and numbers are supported as <option> children.")))}),t}function ie(e,t,a,n,l,o){var i="<"+e;for(var r in a)if(Ba.call(a,r)){var s=a[r];if(null!=s){"style"===r&&(s=ee(s));var d=null;X(t,a)?!Fa.hasOwnProperty(r)&&(d=v(r,s)):d=N(r,s),d&&(i+=" "+d)}}// For static pages, no need to put React ID and checksum. Saves lots of
// bytes.
return l?i:(o&&(i+=" "+k()),i)}function re(e,t){if(e===void 0)throw Error((l(t)||"Component")+"(...): Nothing was returned from render. This usually means a return statement is missing. Or, to render nothing, return null.")}function se(e,t,a){// Extra closure so queue and replace can be captured properly
...
for(var a=Oe.ReactDebugCurrentFrame,n=a.getStackAddendum(),l=arguments.length,o=Array(0),i=2;i<void 0;i++)(void 0)[i-2]=arguments[i];he.apply(void 0,[!1,t+"%s"].concat(void 0,[n]))}};var Pe=Re,Le=function(){};{var Me=function(e){for(var t=arguments.length,a=Array(1<t?t-1:0),n=1;n<t;n++)a[n-1]=arguments[n];var l=0,o="Warning: "+e.replace(/%s/g,function(){return a[l++]});"undefined"!=typeof console&&console.warn(o);try{// --- Welcome to debugging React ---
// This error was thrown as a convenience so that you can use this stack
// to find the callsite that caused this warning to fire.
throw new Error(o)}catch(e){}};Le=function(e,t){if(t===void 0)throw new Error("`lowPriorityWarningWithoutStack(condition, format, ...args)` requires a warning message argument");if(!e){for(var a=arguments.length,n=Array(2<a?a-2:0),l=2;l<a;l++)n[l-2]=arguments[l];Me.apply(void 0,[t].concat(n))}}}var De=Le,He=/^(.*)[\\\/]/,Be=function(e,t,a){var n="";if(t){var l=t.fileName,o=l.replace(He,"");// In DEV, include code for a common special case:
...
/* eslint-disable max-len */var nt=/^[\u0000-\u001F ]*j[\r\n\t]*a[\r\n\t]*v[\r\n\t]*a[\r\n\t]*s[\r\n\t]*c[\r\n\t]*r[\r\n\t]*i[\r\n\t]*p[\r\n\t]*t[\r\n\t]*\:/i,lt=!1,ot=/["'&<>]/,it="function"==typeof Object.is?Object.is:function(e,t){return e===t&&(0!==e||1/e==1/t)||e!==e&&t!==t// eslint-disable-line no-self-compare
...
for(var n=[""],l=!1;n[0].length<e;){if(0===this.stack.length){this.exhausted=!0,m(this.threadID);break}var o=this.stack[this.stack.length-1];if(l||o.childIndex>=o.children.length){var i=o.footer;if(""!==i&&(this.previousWasTextNode=!1),this.stack.pop(),"select"===o.type)this.currentSelectValue=null;else if(null!=o.type&&null!=o.type.type&&o.type.type.$$typeof===Ce){var r=o.type;this.popProvider(r)}else if(o.type===ve){this.suspenseDepth--;var s=n.pop();if(l){l=!1;// If rendering was suspended at this boundary, render the fallbackFrame
...
case we:throw Error("ReactDOMServer does not yet support scope components.");}var F="";{var W=m._owner;(void 0===f||"object"===_typeof2(f)&&null!==f&&0===Object.keys(f).length)&&(F+=" You likely forgot to export your component from the file it's defined in, or you might have mixed up default and named imports.");var U=W?l(W):null;U&&(F+="\n\nCheck the render method of `"+U+"`.")}throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: "+(null==f?f:_typeof2(f))+"."+F)},t.renderDOM=function(e,t,a){var n=e.type.toLowerCase(),l=a;a===_t.html&&(l=U(n)),l===_t.html&&(n===e.type?void 0:Pe(!1,"<%s /> is using incorrect casing. Use PascalCase for React components, or lowercase for HTML elements.",e.type)),J(n);var o=e.props;if("input"===n)bt.checkPropTypes("input",o),void 0===o.checked||void 0===o.defaultChecked||Ta||(Pe(!1,"%s contains an input of type %s with both checked and defaultChecked props. Input elements must be either controlled or uncontrolled (specify either the checked prop, or the defaultChecked prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://fb.me/react-controlled-components","A component",o.type),Ta=!0),void 0===o.value||void 0===o.defaultValue||Ca||(Pe(!1,"%s contains an input of type %s with both value and defaultValue props. Input elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled input element and remove one of these props. More info: https://fb.me/react-controlled-components","A component",o.type),Ca=!0),o=ue({type:void 0},o,{defaultChecked:void 0,defaultValue:void 0,value:null==o.value?o.defaultValue:o.value,checked:null==o.checked?o.defaultChecked:o.checked});else if("textarea"===n){bt.checkPropTypes("textarea",o),void 0===o.value||void 0===o.defaultValue||Na||(Pe(!1,"Textarea elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled textarea and remove one of these props. More info: https://fb.me/react-controlled-components"),Na=!0);var r=o.value;if(null==r){var s=o.defaultValue,d=o.children;// TODO (yungsters): Remove support for children content in <textarea>.
if(null!=d){if(Pe(!1,"Use the `defaultValue` or `value` props instead of setting children on <textarea>."),null!=s)throw Error("If you supply `defaultValue` on a <textarea>, do not pass children.");if(Array.isArray(d)){if(!(1>=d.length))throw Error("<textarea> can only have at most one child.");d=d[0]}s=""+d}null==s&&(s=""),r=s}o=ue({},o,{value:void 0,children:""+r})}else if("select"===n){{bt.checkPropTypes("select",o);for(var u=0,c;u<Ra.length;u++)if(c=Ra[u],null!=o[c]){var m=Array.isArray(o[c]);o.multiple&&!m?Pe(!1,"The `%s` prop supplied to <select> must be an array if `multiple` is true.",c):!o.multiple&&m&&Pe(!1,"The `%s` prop supplied to <select> must be a scalar value if `multiple` is false.",c)}void 0===o.value||void 0===o.defaultValue||ka||(Pe(!1,"Select elements must be either controlled or uncontrolled (specify either the value prop, or the defaultValue prop, but not both). Decide between using a controlled or uncontrolled select element and remove one of these props. More info: https://fb.me/react-controlled-components"),ka=!0)}this.currentSelectValue=null==o.value?o.defaultValue:o.value,o=ue({},o,{value:void 0})}else if("option"===n){var f=null,p=this.currentSelectValue,h=oe(o.children);if(null!=p){var g;if(g=null==o.value?h:o.value+"",f=!1,Array.isArray(p)){// multiple
for(var _=0;_<p.length;_++)if(""+p[_]===g){f=!0;break}}else f=""+p===g;o=ue({selected:void 0,children:void 0},o,{selected:f,children:h})}}ha(n,o),z(n,o);var y=ie(e.type,n,o,l,this.makeStaticMarkup,1===this.stack.length),b="";kt.hasOwnProperty(n)?y+="/>":(y+=">",b="</"+e.type+">");var E=ne(o),C;null==E?C=da(o.children):(C=[],Pa[n]&&"\n"===E.charAt(0)&&(y+="\n"),y+=E);var T={domNamespace:V(a,e.type),type:n,children:C,childIndex:0,context:t,footer:b};return T.debugElementStack=[],this.stack.push(T),this.previousWasTextNode=!1,y},e}(),Ua=/*#__PURE__*/function(e){function t(t,a){var n;// Calls the stream.Readable(options) constructor. Consider exposing built-in
