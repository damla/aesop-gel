...
const Button = ({
  ...
  if (handleClick || type !== 'button') {
    return (
      <button
        className={cx(classSet, { [styles.action]: handleClick || type })}
    ...
    console.error(
      '<Button /> Make sure you pass a prop to make this work, href, to or handleClick',
    );
