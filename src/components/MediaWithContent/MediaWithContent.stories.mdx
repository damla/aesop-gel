    ...
    {(() => {
      ...
      return (
        <div style={{position: 'relative'}}>
          {/*
          <nav style={{position: 'relative', height: '40px', color: 'white', zIndex: '1000', padding:  '20px'}}>Shop  Read  Search  Stores</nav>
          <span style={{position: 'absolute', top: '195px', color: 'white', zIndex: '1000', paddingLeft: '20px'}}>Aesop</span>
          */}
          <MediaWithContent
