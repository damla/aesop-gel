      ...
      return (
        <MediaWithContent
          ...
          copy={{
            ...
            eyebrow: text('eyebrow', MediaWithContentFixture.copy.default.eyebrow),
            heading: text('heading', MediaWithContentFixture.copy.default.heading),
            subHeading: text('subHeading', MediaWithContentFixture.copy.default.subHeading),
          }}
    ...
    <MediaWithContent
      ...
      media={
        <Video
          ...
          poster={MediaWithContentFixture.video.poster}
