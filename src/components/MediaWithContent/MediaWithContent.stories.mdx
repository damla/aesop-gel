...
<Preview>
  <Story name="Base Component">
    {(() => {
      ...
      const hasHeader = knobs.boolean('hasHeader', false, 'Presentation');
      return (
        <div style={{position: 'relative'}}>
          {hasHeader && (
            <>
              <nav style={{position: 'relative', height: '40px', color: 'white', zIndex: '1000', padding:  '20px', borderBottom: '1px solid white' }}>Shop  Read  Search  Stores</nav>
